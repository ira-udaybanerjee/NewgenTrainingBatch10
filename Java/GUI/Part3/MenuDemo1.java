...
public class MenuDemo1 {
	...
	public MenuDemo1()
	{
		...
		formcustomer.setActionCommand("frm_Customer");
		formcustomer.addActionListener(new MenuHandler());
		
		formsalesperson = new JMenuItem("Salesperson Data");
		formsmenu.add(formsalesperson);
		
		formsalesperson.setActionCommand("frm_Salesperson");
		formsalesperson.addActionListener(new MenuHandler());
